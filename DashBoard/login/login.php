...
if($_SERVER["REQUEST_METHOD"] ==='POST'){
    ...
    if(!empty($_POST['email'])&&!empty($_POST['pass'])){
        ...
        if($row['email']==$email && $row['password_']==$pass){
            ...
            header('REFRESH: 0 ; URL =../login/error.php');
        }
...
if($x==0){
    echo'<div class="row">
    <div class="col-12">
    <div class="alert alert-danger">wrong in email or password</div></div></div>';
}
if(empty($_POST['email'])|| empty($_POST['pass'])){
    echo'<div class="row">
    <div class="col-12">
    <div class="alert alert-danger">complete information!</div></div></div>';
}
}
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="POST">
                                        ...
                                        &nbsp&nbsp&nbsp<a href="sign up.php">create account?</a>
